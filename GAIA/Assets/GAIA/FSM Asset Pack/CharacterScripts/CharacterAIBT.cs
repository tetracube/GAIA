...
public class CharacterAIBT : MonoBehaviour
{
    ...
    [Task]
    bool tooClose() { return distance <= 5; }

    [Task]
    bool isStopped() { return previousPosition == m_Rigidbody.transform.position; }
    ...
    {
        frame++;
        PlayerPosition = GameObject.Find("EnemyCharacter").transform.position;
        ...
        {
            #if (PANDA)
            manager.changeBT(gameObject, "BTDoom");
            frame = -100000;
            #endif
        }
    }
