...
public class NavMeshMovementBT : MonoBehaviour
{
    ...
    bool Teleport()
    {
        ...
        float positionX = Random.Range(-15f, 15f);
        float positionY = Random.Range(-15f, 15f);

        Vector3 newPosition = tank.transform.localPosition;
